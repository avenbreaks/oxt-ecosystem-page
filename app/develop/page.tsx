...
import { InteractiveGuide, CodeBlock } from "@/components/interactive-guide"
  ...
  return (
    <>
      ...
      <main className="min-h-screen">
        ...
        <section className="py-16">
          <div className="container mx-auto px-4 md:px-8">
            <div className="max-w-4xl mx-auto">
              <h2 className="text-3xl font-bold mb-8 text-center">How to Become a Validator</h2>
              <p className="text-muted-foreground text-center mb-12 max-w-2xl mx-auto">
                Join the Oorth Nexus network as a validator operator and help secure the ecosystem while earning rewards.
              </p>
                  ...
                  <Card key={index} className="p-6">
                    <div className="flex items-start gap-4">
                      ...
                      <div className="flex-1">
                        ...
                        {step.code && (
                          <div className="bg-secondary p-3 rounded-lg font-mono text-sm mb-3">
                        ...
                        {step.requirements && (
                          <ul className="space-y-1">
                            {step.requirements.map((req, reqIndex) => (
                              <li key={reqIndex} className="text-sm flex items-center gap-2">
              ...
              {/* Validator Economics */}
              <Card className="mt-12 p-6 bg-gradient-to-br from-primary/5 to-accent/5">
                <div className="text-center mb-6">
                  <h3 className="text-xl font-semibold mb-2">Validator Economics & Requirements</h3>
                  <p className="text-muted-foreground">Understanding rewards, penalties, and operational requirements</p>
                </div>
                <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-6">
                  <div className="text-center">
                    <div className="text-2xl font-bold text-primary mb-1">32,000</div>
                    <div className="text-sm text-muted-foreground">Minimum OORTH stake</div>
                  </div>
                  <div className="text-center">
                    <div className="text-2xl font-bold text-primary mb-1">5-12%</div>
                    <div className="text-sm text-muted-foreground">Annual staking APY</div>
                  </div>
                  <div className="text-center">
                  ...
                  <div className="text-center">
                    <div className="text-2xl font-bold text-primary mb-1">21 days</div>
                    <div className="text-sm text-muted-foreground">Unbonding period</div>
                  </div>
                </div>
                <div className="border-t pt-6">
                  <h4 className="font-semibold mb-3 text-center">Key Considerations</h4>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                    <div className="flex items-start gap-2">
                      <Shield className="h-4 w-4 text-green-500 flex-shrink-0 mt-0.5" />
                      <div>
                        <strong>Rewards:</strong> Earn block rewards and transaction fees. Higher uptime = higher rewards.
                      </div>
                    </div>
                    <div className="flex items-start gap-2">
                      <Zap className="h-4 w-4 text-yellow-500 flex-shrink-0 mt-0.5" />
                      <div>
                        <strong>Slashing:</strong> Validators face penalties for downtime (0.5%) or double-signing (5-100% stake).
                      </div>
                    </div>
                    <div className="flex items-start gap-2">
                      <Coins className="h-4 w-4 text-blue-500 flex-shrink-0 mt-0.5" />
                      <div>
                        <strong>Delegation:</strong> Accept delegated stake from token holders. Set your commission rate (0-100%).
                      </div>
                    </div>
                    <div className="flex items-start gap-2">
                      <Server className="h-4 w-4 text-purple-500 flex-shrink-0 mt-0.5" />
                      <div>
                        <strong>Costs:</strong> Factor in server costs ($100-500/month), electricity, and monitoring tools.
                      </div>
                    </div>
                  </div>
                </div>
        ...
        {/* Validator Monitoring & Management */}
        <section className="py-16 bg-secondary/30">
          <div className="container mx-auto px-4 md:px-8">
            <div className="max-w-4xl mx-auto">
              <h2 className="text-3xl font-bold mb-8 text-center">Validator Monitoring & Management</h2>
              
              <div className="space-y-8">
                <Card className="p-6">
                  <div className="flex items-center gap-3 mb-4">
                    <Server className="h-6 w-6 text-primary" />
                    <h3 className="text-xl font-semibold">Node Setup & Configuration</h3>
                  </div>
                  <div className="space-y-4">
                    <div className="bg-secondary p-4 rounded-lg">
                      <p className="text-sm font-medium mb-2">1. Configure your validator node:</p>
                      <code className="text-sm bg-background p-2 rounded block">
                        {`# Edit validator configuration
oorth-validator config edit --validator-key=<your-key>

# Set commission rate (0-100%)
oorth-validator config set-commission 5

# Configure network endpoints
oorth-validator config set-rpc https://rpc.oorthnexus.io`}
                      </code>
                    </div>
                    <div className="bg-secondary p-4 rounded-lg">
                      <p className="text-sm font-medium mb-2">2. Start your validator node:</p>
                      <code className="text-sm bg-background p-2 rounded block">
                        {`# Start validator in background
oorth-validator start --daemon

# Check node status
oorth-validator status

# View logs
oorth-validator logs --follow`}
                      </code>
                    </div>
                  </div>
                </Card>
                ...
                <Card className="p-6">
                  ...
                  <p className="text-muted-foreground mb-4">
                    Monitor your validator's performance, uptime, and rewards to ensure optimal operation.
                  </p>
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <div className="bg-secondary p-4 rounded-lg text-center">
                      <Activity className="h-8 w-8 text-green-500 mx-auto mb-2" />
                      <div className="text-sm font-medium">Uptime Monitoring</div>
                      <div className="text-xs text-muted-foreground">Track validator availability</div>
                    </div>
                    <div className="bg-secondary p-4 rounded-lg text-center">
                      <Coins className="h-8 w-8 text-blue-500 mx-auto mb-2" />
                      <div className="text-sm font-medium">Reward Tracking</div>
                      <div className="text-xs text-muted-foreground">Monitor earnings & APY</div>
                    </div>
                    <div className="bg-secondary p-4 rounded-lg text-center">
                      <Shield className="h-8 w-8 text-purple-500 mx-auto mb-2" />
                      <div className="text-sm font-medium">Security Alerts</div>
                      <div className="text-xs text-muted-foreground">Slashing protection</div>
                    </div>
                  </div>
                </Card>
                ...
                <Card className="p-6">
                  <div className="flex items-center gap-3 mb-4">
                    ...
                    <h3 className="text-xl font-semibold">Staking & Delegation</h3>
                  </div>
                  <p className="text-muted-foreground mb-4">
                    Manage your stake and accept delegations from other OORTH token holders.
                  </p>
                  <div className="space-y-4">
                    <div className="bg-secondary p-4 rounded-lg">
                      <p className="text-sm font-medium mb-2">Stake additional OORTH tokens:</p>
                      <code className="text-sm bg-background p-2 rounded block">
                        oorth-validator stake add --amount 1000 --validator &lt;validator-address&gt;
                      </code>
                    </div>
                    <div className="bg-secondary p-4 rounded-lg">
                      <p className="text-sm font-medium mb-2">Check delegation status:</p>
                      <code className="text-sm bg-background p-2 rounded block">
                        oorth-validator delegations list --validator &lt;validator-address&gt;
                      </code>
                    </div>
                  </div>
                </Card>
